document.addEventListener('DOMContentLoaded', function () {
  ...
  if (urlValue.startsWith('yt-') || urlValue.startsWith('vimeo-')) {
    let youtubeVideoId = urlValue.replace('yt-', '');
    ...
    if (urlValue.startsWith('yt-')) {
      iframeElement.src = `https://www.youtube.com/embed/${youtubeVideoId}?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1`;
      ...
      iframeElement.src = `https://player.vimeo.com/video/${youtubeVideoId}?loop=false&amp;byline=false&amp;portrait=false&amp;title=false&amp;speed=true&amp;transparent=0&amp;gesture=media`;
    }
